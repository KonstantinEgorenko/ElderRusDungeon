...
void UHeroGameplayAbility_TargetLock::SetTargetLockWidgetPosition()
{
	...
	float VerticalOffset = 100.0f;// величина смещения вверх по оси Z
	FVector ActorLocation = CurrentLockedActor->GetActorLocation();
	ActorLocation.Z += VerticalOffset;

	FVector2D ScreenPosition;
	UWidgetLayoutLibrary::ProjectWorldLocationToWidgetPosition(
		GetHeroControllerFromActorInfo(),
		ActorLocation,//CurrentLockedActor->GetActorLocation(),
		ScreenPosition,
		true
	);
